#!/bin/bash
# fetch_and_analyse.sh — On-Lattice vs Off-Lattice Comparison
set -e
...
echo "=== On-Lattice vs Off-Lattice — Fetch & Analyse ==="
...
if [[ "$SKIP_ANALYSIS" == false ]]; then
  ANALYSIS_OUT="$OUTPUT_DIR/lattice_comparison_analysis"
