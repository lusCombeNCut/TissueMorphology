...
# ── paths ─────────────────────────────────────────────────────────────────────
VERTEX_ROOT = ('/home/orlando/Thesis/sim_results/2d_sim_06042026/'
               '2d_sim_0904_Vertex_mutations')
NODE_ROOT   = ('/home/orlando/Thesis/sim_results/2d_sim_06042026/'
               '16571895_node2d_2026-04-06_11-56-52')
...
def main():
    ...
    make_figure(
        ...
        model_label='Node 2D',
        node_model=True,
        output_path=os.path.join(args.output_dir, 'node2d_cell_type_counts.svg'),
    )
